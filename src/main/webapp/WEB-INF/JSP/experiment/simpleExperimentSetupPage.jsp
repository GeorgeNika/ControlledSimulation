...
<div class="div70_with_overflow">
    ...
    <div>
                    ...
                    <tr>
                        <td>
                            <form:form method="POST"
                                       action="${context}/editSimpleExperimentExtraDataAction/${experiment.idExperiment}"
                                       commandName="simpleExperimentExtraDataForm">
                                <table>
                                    <tr><h6></h6></tr>
                                    <tr>
                                        <td>Info String</td>
                                        <td><form:input path="infoString"/></td>

                                    </tr>
                                    <tr>
                                        <td>Info Int</td>
                                        <td><form:input path="infoInt" type='number' min='0'/></td>
                                    </tr>
                                    <tr>
                                        <td>Info Long</td>
                                        <td><form:input path="infoLong" type='number' min='0'/></td>
                                    </tr>
                                    <tr>
                                        <td>Info Start Time</td>
                                        <td><form:input path="infoStartTime" id="infoTime"/></td>
                                    </tr>
                                    <tr>
        ...
        <div class="right20_div">
            <div class="space35_div">
                <img src="${context}/resources/images/button_generator_list.png" alt="list" class="round_button"
