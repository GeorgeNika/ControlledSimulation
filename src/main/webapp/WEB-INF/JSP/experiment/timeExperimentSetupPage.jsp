                    ...
                    <tr>
                        <td>
                            <form:form method="POST"
                                       action="${context}/editTimeExperimentExtraDataAction/${experiment.idExperiment}"
                                       commandName="timeExperimentExtraDataForm">
                                <table>
                                    <tr><h6></h6></tr>
                                    <tr>
                                        <td>Id Start Generator</td>
                                        <td><form:input path="idStartGenerator" type='number' min='0'/></td>

                                    </tr>
                                    <tr>
                                        <td>Id End Generator</td>
                                        <td><form:input path="idEndGenerator" type='number' min='0'/></td>
                                    </tr>
                                    <tr>
