...
<div class="full_line_header">
    ...
    <div class="center80_div" id="info_header">
        <span>PRICE REPEAT EXPERIMENT</span>
    </div>
                    ...
                    <tr>
                        <td>
                            <form:form method="POST"
                                       action="${context}/editPriceExperimentExtraDataAction/${experiment.idExperiment}"
                                       commandName="priceExperimentExtraDataForm">
                                <table>
                                    <tr><h6></h6></tr>
                                    <tr>
                                        <td>Min price</td>
                                        <td><form:input path="minPrice" type='number' min='0'/></td>
                                    </tr>
                                    <tr>
                                        <td>Max price</td>
                                        <td><form:input path="maxPrice" type='number' min='0'/></td>
                                    </tr>
                                    <tr>
                                        <td>Experiment points</td>
                                        <td><form:input path="repeat" type='number' min='2'/></td>
                                    </tr>
                                    <tr>
                                        <td>Disable variation</td>
                                        <td><form:checkbox  path="zeroVariation"/></td>
                                    </tr>
                                    <tr>
