...
<head>
    ...
    <link rel="stylesheet" href="${context}/resources/css/generator/route_generator_v01.css" type="text/css">

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js"></script>
</head>
<body class="whole_route_page">
...
<div class="space20_div">
    ...
    <div class="right33_div">
        <img src="${context}/resources/images/button_BSInfo.png" alt="info" class="round_button"
             onclick="window.location.href='${context}/busStartInfoSetupPage/${generator.idGenerator}'">
    </div>
</div>
<div hidden>
